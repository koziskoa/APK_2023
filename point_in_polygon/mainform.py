...
class Ui_MainForm(object):
    def setupUi(self, MainForm):
        ...
        icon = QtGui.QIcon()# point_in_polygon\icons
        icon.addPixmap(QtGui.QPixmap("point_in_polygon/icons/clear.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionClear.setIcon(icon)
        self.actionClear.setObjectName("actionClear")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("point_in_polygon/icons/polygon.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("point_in_polygon/icons/open_file.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionOpen.setIcon(icon2)
        self.actionOpen.setObjectName("actionOpen")
        self.actionExit = QtGui.QAction(parent=MainForm)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("point_in_polygon/icons/exit.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.menubar.addAction(self.menuFile.menuAction())
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("point_in_polygon/icons/about.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    def analyzePosition(self):
        ...
        for i in range(len(pol_list)):
            ...
            self.Canvas.repaint()
        # Alert the user if the point is located on an edge
    ...
    def clearClick(self):
        """Clears canvas."""
        # Call event handler from Draw class
        self.Canvas.clearEvent()
    ...
    def onEdgePopup(self):
        """Creates a popup if point is on an edge of a polygon."""
        dlg = QtWidgets.QMessageBox()
